...
export default function Home() {
    const videoSnippets = [
    {
        title: "Melancholic Beats",
        description: "A journey into deep thoughts through melodies.",
          ...
          <div className="bg-gradient-to-b from-gray-800 to-gray-900 text-white min-h-screen">
            <nav className="flex justify-between items-center p-6 bg-gray-900">
              ...
              <div className="space-x-4">
                <Link href="https://www.youtube.com/@ghost_endy" target="_blank">
                  <a className="hover:text-gray-400">YouTube</a>
                </Link>
                <Link href="https://open.spotify.com/artist/2iHVgzUJwEYLY1MTMQf8X6" target="_blank">
                  <a className="hover:text-gray-400">Spotify</a>
                </Link>
                <Link href="/newsletters">
                  <a className="hover:text-gray-400">Newsletters</a>
                </Link>
              </div>
            </nav>
                      ...
                      <div key={index} className="min-w-full flex-shrink-0">
                        ...
                        <div className="p-4 bg-gray-800">
                          ...
                          <Link href={video.link}>
                            <a className="text-blue-400 hover:underline mt-4 block">Watch on YouTube</a>
                          </Link>
                        </div>
                      </div>
                    ))}
