        ...
        <nav className="flex justify-between items-center p-6 bg-[#f4f1ed] shadow-lg">
          ...
          <div className="space-x-6">
            <Link href="https://www.youtube.com/@ghost_endy" target="_blank">
              <a className="hover:text-gray-600">YouTube</a>
            </Link>
            <Link href="https://www.instagram.com/" target="_blank">
              <a className="hover:text-gray-600">Instagram</a>
            </Link>
            <Link href="https://www.tiktok.com/" target="_blank">
              <a className="hover:text-gray-600">TikTok</a>
            </Link>
            <Link href="https://open.spotify.com/artist/2iHVgzUJwEYLY1MTMQf8X6" target="_blank">
              <a className="hover:text-gray-600">Música</a>
            </Link>
            <Link href="/newsletters">
              <a className="hover:text-gray-600">Newsletter</a>
            </Link>
          </div>
        </nav>
